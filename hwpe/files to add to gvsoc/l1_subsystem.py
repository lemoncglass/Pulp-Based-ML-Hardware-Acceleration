...
class L1_subsystem(st.Component):
    ...
    def __init__(self, parent, name, cluster, cluster_conf):
        ...
        custom_hwpe_ico = Router(self, 'custom_hwpe_ico')
        custom_hwpe_ico.add_mapping('l1', **cluster._reloc_mapping(cluster_conf.get_property('l1/mapping')))
        self.bind(self, 'custom_hwpe_in', custom_hwpe_ico, 'input')
        self.bind(custom_hwpe_ico, 'l1', interleaver, 'in_%d' % (nb_pe + 4))
