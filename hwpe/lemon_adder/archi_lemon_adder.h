/*
 * Lemon Adder HWPE — Architecture / Register Map
 *
 ...
 * job-specific registers — for the lemon adder that is just three:
 *   operand A, operand B, and the result.
 * 
 */

#ifndef __ARCHI_LEMON_ADDER_H__
#define __ARCHI_LEMON_ADDER_H__
...
#define LEMON_ADDER_BASE_ADD   0x10201000
...
#define LEMON_ADDER_REG_A_PTR    0x00   // relative to REG_OFFS   -> REG_OFFS + 0x00
#define LEMON_ADDER_REG_B_PTR    0x04   // ^                      -> REG_OFFS + 0x04
#define LEMON_ADDER_REG_RES_PTR  0x08   // ^                      -> REG_OFFS + 0x08

/* ---- Event used by the HWPE to signal completion ---- */
#define LEMON_ADDER_EVT0         12

#endif /* __ARCHI_LEMON_ADDER_H__ */
